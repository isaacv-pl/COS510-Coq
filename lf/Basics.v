...
Theorem mult_n_1 : forall p : nat,
  p * 1 = p.
Proof.
  intros. simpl. rewrite <- mult_n_Sm. rewrite <- mult_n_O. simpl.
  reflexivity.
Qed.
(** [] *)
...
Proof.
  intros. destruct c.
  - reflexivity.
  - destruct b. discriminate H. discriminate H.
Qed.
...
Theorem negation_fn_applied_twice :
  forall (f : bool -> bool),
    ...
    forall (b : bool), f (f b) = b.
Proof.
  intros. rewrite H. rewrite H.  apply negb_involutive.
Qed.
(* FILL IN HERE *)
...
Proof.
  intros.  rewrite apply_late_policy_unfold. rewrite H.
  auto.
Qed.
...
Fixpoint helper (m: bin) (count : nat) : nat :=
match m with
| Z => O
| B0 n => helper n (S count)
| B1 n =>  (plus (exp 2 count) (helper n (S count)))
end.
