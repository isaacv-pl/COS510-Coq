...
Proof.
intros. unfold t_update. apply functional_extensionality.
intros. destruct (x =? x0)%string eqn:eqX.
- apply String.eqb_eq in eqX. rewrite eqX. reflexivity.
- reflexivity.
Qed.
(** [] *)
...
apply String.eqb_neq in H. unfold t_update.
destruct (x1 =? x)%string eqn:xEq.
- apply String.eqb_eq in xEq. rewrite xEq in H.
  rewrite H. reflexivity.
- reflexivity.
Qed.
(** [] *)
