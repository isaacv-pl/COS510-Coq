...
(** Which of the following are well-typed elements of [grumble X] for
    some type [X]?  (Add YES or NO to each line.)
      ...
      - [e mumble (b c 0)] YES
      - [e bool (b c 0)] NO
      - [c]  NO because well typed element of mumble*)
(* FILL IN HERE *)
End MumbleGrumble.
(** [] *)
...
(** **** Exercise: 3 stars, standard (map_rev)
    ...
    auxiliary lemma. *)
Theorem map_distr : forall (X Y : Type) (f : X -> Y) (h : X) (l : list X),
...
Proof.
  intros. induction l.
  - simpl. reflexivity.
  - simpl. rewrite map_distr. rewrite IHl.
    reflexivity.
Qed.
(** [] *)
...
(* If you want to create a mapping for which numbers
are even in a list of numbers
...
Proof.
  intros. induction l.
  - simpl. reflexivity.
  - simpl. rewrite <- IHl. unfold fold_length. simpl.
    reflexivity.
Qed.
(** [] *)
...
Proof.
  intros. induction l.
  - simpl. reflexivity.
  - simpl. rewrite <- IHl. unfold fold_map. simpl.
    reflexivity.
Qed.
...
Proof.
intros. simpl. unfold prod_curry.  unfold prod_uncurry.
reflexivity.
Qed.
...
Proof.
  simpl. unfold scc. unfold one. unfold zero.
  reflexivity.
Qed.
